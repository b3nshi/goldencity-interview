...
function Home() {
  ...
  return (
    <div className="space-y-16">
          ...
          {investmentSteps.map((step, index) => (
            ...
            >
              <div className="bg-white dark:bg-secondary-800 p-6 rounded-lg shadow-md text-center transition-colors duration-300">
                ...
                <div className="text-primary-600 dark:text-primary-400 text-2xl font-bold mb-4">
                  Step {index + 1}
                </div>
      ...
      {/* How It Works */}
      <section className="bg-secondary-900 dark:bg-secondary-700 text-white py-16 transition-colors duration-300">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 dark:text-secondary-100">
              How GoldenCity Works
            </h2>
            <p className="text-secondary-300 dark:text-secondary-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {howItWorks.map((item, index) => (
              ...
              >
                ...
                <p className="text-secondary-300 dark:text-secondary-400 text-center">
                  {item.description}
                </p>
              </motion.div>
            ))}
      ...
      <section className="container">
        <div className="bg-primary-600 dark:bg-primary-700 rounded-2xl p-8 md:p-12 text-white text-center transition-colors duration-300">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button className="btn bg-primary-700 hover:bg-primary-800 dark:bg-primary-600 dark:hover:bg-primary-500">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts.map((post, index) => (
            <motion.article
              ...
              className="bg-white dark:bg-secondary-900 rounded-lg shadow-md overflow-hidden transition-colors duration-300"
            >
